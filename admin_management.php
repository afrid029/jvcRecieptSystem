...
<body class="bg-sky-50 text-slate-900 min-h-screen p-4 md:p-8">
    ...
    <div class="max-w-6xl mx-auto space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1 h-fit">
                <div class="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-sky-200 sticky top-8">
                    ...
                    <form action="admin_actions.php" method="POST" class="space-y-4">
                        ...
                        <button type="submit"
                            class="w-full py-2 bg-emerald-600 hover:bg-emerald-700 rounded-lg font-bold transition-all shadow-lg text-sm text-white">Create
                            Admin</button>
                    </form>
                </div>
            </div>
            ...
            <div class="md:col-span-2">
                <div
                    class="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-sky-200 overflow-hidden">
